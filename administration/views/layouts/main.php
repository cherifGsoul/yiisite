...
<div class="container" id="page">
	...
	<div id="header">
		<div id="logo"><?php echo CHtml::encode(Yii::app()->name); ?></div>
                <div id="right-info">You are connected as <?php echo CHtml::link(CHtml::encode(Yii::app()->user->name),array('user/view',  'id'=>Yii::app()->user->id)); ?></div>
	</div><!-- header -->
		...
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				array('label'=>'Home', 'url'=>array('/dashboard/index')),
                                array('label'=>'Content', 'url'=>array('/page/index', 'view'=>'page')),
